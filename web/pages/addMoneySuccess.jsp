...
<div class="container">
    ...
    <div class="col-md-3 text-right" style="padding-top:30px">
        <ol class="list-inline">
            <li>
                <a href="${pageContext.request.contextPath}/static/login.jsp">已有账号,立即登录</a>
            </li>
        </ol>
    </div>
</div>--%>
...
<div class="container" style="height: 650px;">
    <div class="row text-center" style="margin-top: 50px;">
        <h1><img src="${pageContext.request.contextPath}/static/img/success.jpg" /> 充值成功，请重新支付</h1>
    </div>
    <hr />
...
<script>
    ...
    setTimeout(function () {
        // 直接跳转
        window.location.href = "${pageContext.request.contextPath}/cart.action";
    },2000);
